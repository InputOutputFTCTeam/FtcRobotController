...
3. IMUAsSensor - гироскоп. Он используется для анализа положения робота в пространстве, кореректирования направления езды (чтобы во время неё робот ездил ровно по заданнаму направлению и поворачивалсяс минималиной погрешностью).
